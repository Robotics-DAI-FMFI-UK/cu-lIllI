...
class Buffer():
	...
	def add(self, td):
		...
		#print(f"DEBUG: Adding tensor dict to buffer. Done shape: {td['done'].shape}")  # Add this line
	...
	def _prepare_batch(self, td):
		...
		"""
		#print(f"DEBUG: Sampled batch, Done shape: {td['done'].shape}")  # Add this line
	...
	def sample(self):
		...
		self._buffer["episode"] = self._buffer["episode"].squeeze(-1)
		print("traj_key shape:", self._buffer["episode"].shape)
		#print("end_key shape:", self._buffer["done"].shape)
		#print("end_key shape:", self._buffer["next", "done"].shape)
