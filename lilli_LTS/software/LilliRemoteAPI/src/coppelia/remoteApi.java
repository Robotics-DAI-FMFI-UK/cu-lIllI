...
{
    static{ 
    	System.load("C:/Program Files/CoppeliaRobotics/CoppeliaSimEdu/programming/remoteApiBindings/java/lib/Windows/remoteApiJava.dll");
    }
    ...
    public native int simxSetJointTargetVelocity(int clientID, int jointHandle, FloatW targetVelocity, int operationMode);
    public native int simxSetJointTargetPosition(int clientID, int jointHandle, FloatW targetPosition, int operationMode);
    ...
    public native int simxGetObjectGroupData(int clientID, int objectType, int dataType, IntWA objectHandle, IntWA intData, FloatWA floatData, StringWA stringData, int simx_opmode_blocking);
