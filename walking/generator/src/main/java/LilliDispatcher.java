...
{    
	...
	// PC->Teensy lilli message types !do not use header(=1), 27, or any other escaped char! (message type is not escaped)
	...
	public static final int REQUEST_SERVO_POSITIONS = 9;
	...
	public static final int SERVO_POSITIONS = 6;


    public static final int LILLI_NUMBER_OF_SERVOS = 25; //3;
